...
const PopularPetition = ({ stats }) => {
  return (
    <div className="bg-slate-100/50 rounded-lg mt-6 overflow-hidden sticky top-[80px] p-5">
      <h6 className="text-sm text-black font-medium">Popularity</h6>
      <div className="mt-4">
        {stats.map((item) => (
          <div className="flex items-center justify-between  rounded-lg cursor-pointer mb-1 px-3 py-2 hover:bg-slate-300/80">
